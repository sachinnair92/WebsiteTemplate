...
<head>
  ...
  ================================================== -->
    ...
    <!-- CSS
  ================================================== -->
 	<script src="js/jquery.min.t3.js"></script>
...
<body class="wrap">
    ...
    <a href="index.html" id="logo"><img src="images/logo_updated.png" alt="Icebrrrg logo" height="200" width="200" /></a>
    </h1>
    </hgroup>
  ...
  <ul class="slides">
    <li>
      ...
      <div class="flex-caption">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pellentesque tortor erat, in imperdiet metus molestie a.</p>
	</div>
    </li>
    <li>
...
<div class="tagline">
        <p>Welcome to BSNL Employees Welfare Website</p>
...
<h2><i class="icon-book icon-large"></i> Booking</h2>
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pellentesque tortor erat, in imperdiet metus molestie a.</p>
...
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pellentesque tortor erat, in imperdiet metus molestie a. Curabitur eget lacinia neque, et maximus felis. Aenean dictum ligula sit amet mattis convallis. Ut cursus, enim eu faucibus luctus, velit purus dapibus tellus, non semper est ipsum nec nibh. Mauris pulvinar nisi turpis, quis lobortis leo condimentum sit amet</p>
</div>
