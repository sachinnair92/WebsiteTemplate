...
<head>
  ...
  <script type="text/javascript" src="js6/jquery.min.js"></script>
  <script type="text/javascript" src="js6/image_slide.js"></script>
</head>
  ...
  <div id="main">
    <div id="header_container">
      <div id="header">
	    <div id="banner">
	      <div id="welcome">
	        <img style="height: 90px;width: 500px;" src="images/logo1.png"/>
	      </div><!--close welcome-->
	...
	<div id="site_content">	
      ...
      <ul class="slideshow">
        <li class="show"><img width="880" height="300" src="images/penguin1.jpeg" alt="" /></li>
        <li><img width="880" height="300" src="images/penguin2.jpeg" alt="" /></li>
      </ul>   
	  ...
	  <div id="content">
        <div class="content_item">
		  <h1>Welcome To Your Website</h1>
            ...
            <p style="text-align: justify">	Phasellus quam neque, auctor rhoncus quam pulvinar, imperdiet hendrerit ex. Donec eros arcu, consequat non magna ut, placerat venenatis purus. Sed ac nulla lacus. Praesent hendrerit ut quam ornare pharetra. Etiam eu urna posuere purus cursus mattis. Pellentesque eget vestibulum mi, in volutpat massa. Maecenas lorem neque, viverra nec blandit in, suscipit a ipsum. In aliquam quam ac vestibulum venenatis. Etiam fermentum tempus turpis, aliquam volutpat felis venenatis id.

            </p>

		  <div class="content_container">
              <img src="images/pic01.jpg" style="width: 200px;height: 100px;margin-top: 20px"/>
              <br/><br/><h3 >Lorem Ipsum</h3>
            ...
            <div class="content_container2">
                <img src="images/pic02.jpg" style="width: 200px;height: 100px;margin-top: 20px"/>
                <br/><br/><h3 >Lorem Ipsum</h3>
                <p style="margin-right: 15px">Mauris sit amet erat ut nisl euismod convallis eu vitae nisl. Praesent vehicula dignissim porta. Suspendisse potenti. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum faucibus rutrum mauris nec vestibulum.</p>
          ...
          <div class="content_container2">
              <img src="images/pic03.jpg" style="width: 200px;height: 100px;margin-top: 20px"/>
              <br/><br/><h3 >Lorem Ipsum</h3>
              <p style="margin-right: 15px">Mauris sit amet erat ut nisl euismod convallis eu vitae nisl. Praesent vehicula dignissim porta. Suspendisse potenti. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum faucibus rutrum mauris nec vestibulum.</p>
